...
import { useTenantSendOtpMutation, useTenantVerifyOtpMutation } from '@/features/tenant/api/tenantPortalAuthApi';
import { useRegisterTenantPushTokenMutation } from '@/features/tenant/api/tenantTicketsApi';
import { getExpoPushToken } from '@/hooks/usePushToken';
import { setTenantCredentials } from '@/features/tenant/store/tenantAuthSlice';
...
export const TenantOTPVerificationScreen: React.FC<TenantOTPVerificationScreenProps> = ({ navigation, route }) => {
  ...
  const [registerPushToken] = useRegisterTenantPushTokenMutation();
  ...
  const handleVerifyOtp = async () => {
    ...
    try {
      ...
      // Register push token in background (fire and forget)
