...
import { useCreateVisitorMutation, useUpdateVisitorMutation, useGetVisitorByIdQuery } from '../../api/visitorsApi';
import { useGetAllBedsQuery, useGetAllRoomsQuery } from '../../api/roomsApi';
import { useLazyGetCitiesQuery, useLazyGetStatesQuery } from '../../api/locationApi';
