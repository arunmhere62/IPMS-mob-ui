...
export const SignupScreenNew: React.FC = () => {
  ...
  const [requiredLegalDocs, setRequiredLegalDocs] = useState<
  ...
  const openLegalDocByType = async (
    types: string | string[],
      ...
      <View>
        ...
        >
          ...
          <View style={{ flex: 1 }}>
            ...
            <Text style={{ marginTop: 2, fontSize: 11, color: "#334155" }}>
              Just a few details — you’re ready to start.
            </Text>
          </View>
        </View>
        ...
        <View style={{ marginBottom: 16 }}>
          ...
          >
            <Ionicons
              ...
              color={Theme.colors.text.secondary}
            />{" "}
            3. Rent Cycle Type <Text style={{ color: "#EF4444" }}>*</Text>
          </Text>
          <Text
            style={{
              fontSize: 11,
          ...
          <TouchableOpacity
            ...
            style={{
              backgroundColor:
                formData.rentCycleType === "CALENDAR" ? "#DBEAFE" : "#F8FAFC",
              borderRadius: 8,
              padding: 12,
              marginBottom: 10,
              borderWidth: 2,
          ...
          <TouchableOpacity
            ...
            style={{
              backgroundColor:
                formData.rentCycleType === "MIDMONTH" ? "#DBEAFE" : "#F8FAFC",
              borderRadius: 8,
              padding: 12,
              borderWidth: 2,
              borderColor:
          ...
          >
            <View
              style={{
                ...
                borderRadius: 4,
                borderWidth: 1,
                borderColor: hasAgreedToLegal
                  ? Theme.colors.primary
                  : "#D1D5DB",
                backgroundColor: hasAgreedToLegal
                  ? Theme.colors.primary
                  : "white",
                alignItems: "center",
                justifyContent: "center",
            ...
            >
              ...
              <Text
                style={{ color: Theme.colors.primary, fontWeight: "700" }}
                onPress={() =>
                  openLegalDocByType("PRIVACY_POLICY", "Privacy Policy")
                }
              >
                Privacy Policy
              </Text>
