...
import { useLazyGetDashboardMonthlyMetricsQuery } from "../../services/api/dashboardApi";
...
export const ExpenseScreen: React.FC<ExpenseScreenProps> = ({ navigation }) => {
  ...
  const [getMonthlyMetrics] = useLazyGetDashboardMonthlyMetricsQuery();
  ...
  const fetchExpenses = useCallback(
    async (
      ...
      try {
        ...
        const monthToUse =
          monthOverride !== undefined ? monthOverride : appliedMonth;
        const yearToUse =
          yearOverride !== undefined ? yearOverride : appliedYear;
  ...
  const handleRefetchMonthlyMetrics = () => {
    // Refresh monthly metrics for the current month
    const now = new Date();
  ...
  return (
    ...
    >
      <ScreenHeader
        title="Expenses"
        subtitle={`${pagination?.total || expenses.length} expenses`}
        showBackButton
        onBackPress={() => navigation.goBack()}
        syncMobileHeaderBg={true}
      />
            ...
            <Card key={expense.s_no} style={{ marginBottom: 10, padding: 12 }}>
              ...
              <View
                style={{
                  flexDirection: "row",
                  alignItems: "center",
                  marginBottom: expense.remarks ? 6 : 2,
                }}
              >
                <Ionicons
      ...
      <AddEditExpenseModal
        ...
        onRefetchMonthlyMetrics={handleRefetchMonthlyMetrics}
      />
        ...
        >
          <TouchableOpacity
            ...
            style={{
              ...
              borderRadius: 10,
              backgroundColor:
                draftMonth === null ? Theme.colors.primary : "#F3F4F6",
            }}
          >
            <Text
              style={{
          ...
          {MONTHS.map((m) => (
            <TouchableOpacity
              ...
              style={{
                ...
                borderRadius: 10,
                backgroundColor:
                  draftMonth === m.value ? Theme.colors.primary : "#F3F4F6",
              }}
            >
              <Text
                style={{
        ...
        <View style={{ flexDirection: "row", flexWrap: "wrap", gap: 10 }}>
          <TouchableOpacity
            ...
            style={{
              ...
              borderRadius: 10,
              backgroundColor:
                draftYear === null ? Theme.colors.primary : "#F3F4F6",
            }}
          >
            <Text
              style={{
          ...
          {years.map((y: number) => (
            <TouchableOpacity
              ...
              style={{
                ...
                borderRadius: 10,
                backgroundColor:
                  draftYear === y ? Theme.colors.primary : "#F3F4F6",
              }}
            >
              <Text
                style={{
